...
function AuthorCreate({ addHandler }) {
    ...
    const authorCreate = useStoreActions(action => action.author.create)
    ...
    const submitHandler = e => {
        ...
        authorCreate({ data: obj, successHandler })
    }
                ...
                <div >
                    <Form onSubmit={submitHandler} className='p-3  bg-dark rounded-3 '   >
                        ...
                        <FormGroup>
                            ...
                            <FormGroup>
                                <Label className='text-light'><b>catchPhrase :</b></Label>
                                <Input
                                    className='my-2 rounded-pill h-25'
                                    type="text"
                                    value={catchPhrase}
                        ...
                        />
                        <Button type="submit" color="success" className='ms-auto rounded-pill ' size='lg'>Save</Button>
                    </Form>
                </div>
            </Col>
            <Col sm={3}>
